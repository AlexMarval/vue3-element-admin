      ...
      fetchData() {
        import('./content.js').then(data => {
          ...
          setTimeout(() => {
            ...
            // Al usar nextTick, la interfaz de carga seguirá mostrándose; por lo tanto, se usa setTimeout en su lugar
            setTimeout(() => {
              window.print()
            }, 100)
          }, 3000)
...
<style lang="scss">
  ...
  .node-article-content {
    ...
    /* Resuelve el problema de dientes de sierra en el escalado de imágenes en IE6-7 */
    img {
