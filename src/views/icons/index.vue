<template>
  <div class="mt-2 mx-5 overflow-hidden">
    <aside>
      <a href="https://vue3-element-admin-site.midfar.com/guide/advanced/icon.html" target="_blank"
        >Add and use
      </a>
    </aside>
    <el-tabs type="border-card">
          ...
          <div class="grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-x-2 gap-y-2">
            <div v-for="item of svgIcons" :key="item">
              <el-tooltip placement="top">
                ...
                <div
                  class="flex flex-col items-center justify-center w-[100px] h-[100px] mx-auto my-2 cursor-pointer text-[#24292e] text-[30px]"
      ...
      <el-tab-pane label="Element-UI Icons">
        <div class="grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-4 p-4">
          ...
          >
            <component :is="ElementPlusIconsVue[item]" class="w-10 h-10 text-gray-800 disabled" />
            <span class="block text-[16px] mt-2 text-center">{{ item }}</span>
          </div>
        </div>
      </el-tab-pane>
